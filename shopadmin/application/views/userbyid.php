...
<div class="m-portlet m-portlet--full-height ">
	...
	<div class="m-portlet__body">
			<div class="tab-pane" id="m_widget4_tab3_content">
				<!--begin::Form-->
		        <?php $attributes = array("name" => "add_user"); echo form_open_multipart("user/update_user/$a_id", $attributes);?>
					...
					<div class="m-portlet__body">	
			            ...
			            <div class="m-form__section m-form__section--middle">
							<div class="m-form__group form-group row">
								...
								<div class="col-lg-6">
									<input type="text" class="form-control m-input" name="a_username" placeholder="" value="<?php echo $a_name;?>">
								</div>
							</div>
							<div class="m-form__group form-group row">
